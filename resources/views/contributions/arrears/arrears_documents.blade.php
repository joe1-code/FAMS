                        ...
                        <div class="row m-0">
                            <div class="col-lg-12">
                                <div class="card w-100">
                                    <div class="card-body">
                                        <h4 class="card-title mb-4" style="display: flex; justify-content:center;">MONTHLY ARREARS PAYMENT DOCUMENTS</h4>
                                        <div id="alert"></div>
                                            ...
                                            <div class="card w-90 p-0">
                                                ...
                                                <div class="card-body">
                                                    <form id="doc_view" method="get">
                                                        ...
                                                        <div class="monthly_preview_doc col-md-12 mt-3" style="display: flex; justify-content:center;">
