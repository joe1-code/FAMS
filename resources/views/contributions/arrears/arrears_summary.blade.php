                    ...
                    <table class="table align-middle table-nowrap mb-0">
                        ...
                        <tbody>
                                <tr>
                                    ...
                                    <td><a href="javascript: void(0);" class="text-body fw-bold">{{'JOHNS'}}</a></td>
                                    <td>{{111}}</td>
                                    <td>{{223}}</td>
                                    <td>{{2024}}</td>
                                    <td><i class="fas fa-phone me-1"></i> {{1234}}</td>
                                    <td><span class="badge badge-pill badge-soft-success font-size-11">Paid</span></td>
                                    <td>
                                        <button type="button" class="btn btn-primary btn-sm btn-rounded waves-effect waves-light view-details-btn" data-id="" data-name="" data-bs-toggle="modal" data-bs-target=".transaction-detailModal">
                                            View Details
                                        </button>
                                    </td>
                                </tr>
