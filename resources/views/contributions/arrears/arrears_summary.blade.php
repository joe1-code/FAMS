...
<head>
    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                 <h4 class="card-title mb-4">Individual Arrears Summary</h4>
                <div class="row">
        <div class="col-md-6">
            <div>&nbsp;</div>
            <div class="computation-group">
                ...
                <thead>
                    <th style="text-align: center;  background-color: #e3f2fd;">Arrears</th>
                    <th style="text-align: center;  background-color: #e3f2fd;">Dates</th>
                    <th style="text-align: center;  background-color: #e3f2fd;">Penalty</th>
                    <th style="text-align: center;  background-color: #e3f2fd;">Penalty(%)</th>
                    <th style="text-align: center;  background-color: #e3f2fd;">Arrears&Penalty</th>
                </thead>
                    <tbody>
                    <!-- @php
                        try {
                    ...
                    @foreach($individual_arrears as $data)
                        <tr class="" style="text-align: center">
                            ...
                            <td style="text-align: center">{{ $data->total_arrears }}</td>
        ...
        <div class="col-md-6">
            <div>
                ...
                <table class="table table-bordered">
                    <tr>
                        <th colspan="4" style="text-align: center; background-color: #e3f2fd ;">INDIVIDUAL BIOGRAPHY</th></tr>
                        <th>Full Names</th>
