...
$(document).ready(function() {
    ...
    fnRowCallback: function(nRow, aData, iDisplayIndex, iDisplayIndexFull) {
       ...
       $('td', nRow).click(function() {
        ...
        document.location.href = '{!! url("monthly_arrears/getForDatatable/arrears_summary") !!}/'+aData['id'];
      }).hover(function() {
